    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white border border-gray-200 p-0 hover:bg-gray-50 hover:text-gray-900"
        ),
        ...
        day_outside:
          "day-outside text-gray-400 hover:bg-gray-50 hover:text-gray-500",
        day_disabled: "text-gray-300 hover:bg-transparent hover:text-gray-300",
        day_range_middle:
